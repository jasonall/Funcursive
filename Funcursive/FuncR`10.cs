namespace Funcursive
{
    ...
    public static class FuncR<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, TResult>
    {
        ...
        /// <param name="f">The inner Func.</param>
        /// <returns>The created Func.</returns>
        public static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Task<TResult>> Create(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, Task<TResult>>, Task<TResult>> f)
        {
