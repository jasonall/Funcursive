namespace Funcursive
{
    ...
    public static class FuncR<T1, T2, T3, T4, T5, T6, TResult>
    {
        ...
        /// <param name="f">The inner Func.</param>
        /// <returns>The created Func.</returns>
        public static Func<T1, T2, T3, T4, T5, T6, Task<TResult>> CreateAsync(Func<T1, T2, T3, T4, T5, T6, Func<T1, T2, T3, T4, T5, T6, Task<TResult>>, Task<TResult>> f)
        {
        ...
        {
            return CreateAsync(f)(value1, value2, value3, value4, value5, value6);
        }
