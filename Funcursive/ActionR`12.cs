namespace Funcursive
{
    ...
    public static class ActionR<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
    {
        ...
        /// <param name="a">The inner Action.</param>
        /// <returns>The created Action.</returns>
        public static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task> Create(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task>, Task> a)
        {
            if (a == null)
            {
                throw new ArgumentNullException("a");
        ...
        {
            return Create(a)(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11, value12);
        }
    }
}