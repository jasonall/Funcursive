namespace Funcursive
{
    ...
    public static class ActionR<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
    {
        /// <summary>
        ...
        public static Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> Create(Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> a)
        {
            if (a == null)
            {
            ...
            Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> outer = null;

            Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> inner = (v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13) =>
            {
                a(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, outer);
            };
        ...
        /// <param name="a">The inner Action.</param>
        /// <returns>The created Action.</returns>
        public static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Task> CreateAsync(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Task>, Task> a)
        {
            if (a == null)
            {
                throw new ArgumentNullException("a");
            ...
            Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Task> outer = null;

            Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Task> inner = (v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13) =>
            {
                return a(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, outer);
            };
        ...
        /// <param name="a">The inner Action.</param>
        public static void Invoke(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7, T8 value8, T9 value9, T10 value10, T11 value11, T12 value12, T13 value13, Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Action<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>> a)
        {
            Create(a)(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11, value12, value13);
        }
        ...
        public static Task InvokeAsync(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7, T8 value8, T9 value9, T10 value10, T11 value11, T12 value12, T13 value13, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, Task>, Task> a)
        {
            return CreateAsync(a)(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11, value12, value13);
        }
    }
}