namespace Funcursive
{
    ...
    public static class FuncR<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>
    {
        /// <summary>
        ...
        public static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> Create(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>, TResult> f)
        {
        ...
        /// <param name="f">The inner Func.</param>
        /// <returns>The created Func.</returns>
        public static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task<TResult>> CreateAsync(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task<TResult>>, Task<TResult>> f)
        {
        ...
        public static TResult Invoke(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7, T8 value8, T9 value9, T10 value10, T11 value11, T12 value12, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult>, TResult> f)
        {
            return Create(f)(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11, value12);
        }
        ...
        public static Task<TResult> InvokeAsync(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7, T8 value8, T9 value9, T10 value10, T11 value11, T12 value12, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Task<TResult>>, Task<TResult>> f)
        {
            return CreateAsync(f)(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10, value11, value12);
        }
        ...
        private static Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResultWrapper> Create<TResultWrapper>(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResultWrapper>, TResultWrapper> f)
        {
            if (f == null)
            {
            ...
            Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResultWrapper> outer = null;

            Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResultWrapper> inner = (v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12) =>
            {
                return f(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, outer);
            };
